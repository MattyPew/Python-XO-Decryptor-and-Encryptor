    ...
    while switch == 0:
        ...
        while switch == 0:
            ...
            if enc.lower() == 'ooooo':
                ...
                print("\033[32mUse -print (show results), -clear (clear all previous imputs, shell history), -supported (show supported imputs), -switch (switch to another mode (decrypt to encrypt))")
    ...
    while switch == 1:
        ...
        while switch == 1:
            ...
            if enc.lower() == 'a':
                ...
                print("\033[32mUse -print (show results), -clear (clear all previous imputs, shell history), -supported (show supported imputs), -switch (switch to another mode (encrypt to decrypt))")
